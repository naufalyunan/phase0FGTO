const posts = [
  ...
  },
  {
    ...
    author: {
      ...
      avatar_url:
        "https://cdn.techinasia.com/wp-content/authors/1114979.jpg?v=1710141216",
    },
    excerpt:
      "Although the city-state has poured nearly US$1 billion into its deeptech dream, many startups have perished or exited the country to prevail.",
    image_src:
      "https://cdn.techinasia.com/wp-content/uploads/2024/07/1719831867_fi-hurdles-dent-singapores-deeptech-ambitions-but-govt-wont-quit.jpg",
    is_premium: true,
  },
  {
    id: 7,
    ...
    author: {
      ...
      avatar_url:
        "https://cdn.techinasia.com/wp-content/authors/1152315.png?v=1719473345",
    },
    excerpt:
      "To avoid setbacks, the country must incentivize renewable energy and reduce its reliance on coal.",
    image_src:
      "https://cdn.techinasia.com/wp-content/uploads/2024/06/1719472942_Screen-Shot-2024-06-27-at-3.22.01-PM.png",
    is_premium: false,
  },
  {
    id: 8,
    ...
    image_src:
      "https://cdn.techinasia.com/wp-content/uploads/2024/02/1707113018_Featured-image-Capital-SEA-Southeast-Asias-funding-landscape.png",
    is_premium: false,
  },
  {
    id: 9,
  ...
  },
  {
    ...
    excerpt:
      "The startup, which was founded in 2023 by four ex-Meta engineers, allows users to earn Max Miles through purchases from over 500 businesses.",
    image_src:
...
function showNews() {
  ...
  posts.forEach((item) => {
    ...
    if (item.is_premium) {
      card.innerHTML = `
          <img src="${item.image_src}" class="card-img-top" alt="${item.title}" />
          <div class="card-body">
            <h5 class="card-title">${item.title}</h5>
            <p class="card-text">${item.excerpt}</p>
            <p class="card-text">
              <small class="text-body-secondary">By ${item.author.display_name}</small>
            </p>
          </div>
        `;
    } else {
      card.innerHTML = `
        <div class="row g-0">
          <div class="col-md-4 d-flex justify-content-center align-items-center">
            <img src="${item.image_src}" class="img-fluid rounded-start" alt="${item.title}">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">${item.title}</h5>
              <p class="card-text">${item.excerpt}</p>
              <p class="card-text"><small class="text-body-secondary">By ${item.author.display_name}</small></p>
            </div>
          </div>
        </div>
      `;
